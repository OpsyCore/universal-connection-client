...
grep -q "PINNED_TAG = \"$TAG\"" core/singbox-config/src/main/kotlin/io/ucc/core/singbox/SingBoxCapabilities.kt 2>/dev/null \
  || grep -rq "\"$TAG\"" core/singbox-config/src/main/kotlin || err "SingBoxCapabilities pin does not match singbox.version ($TAG)"
...
grep -rq "sing-box" core/engine-singbox/src/main/kotlin core/singbox-config/src/main/kotlin || err "core descriptor does not name sing-box"
